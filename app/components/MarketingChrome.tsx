  ...
  return (
    <footer className="relative overflow-hidden bg-[#061634] px-4 pb-8 pt-5 text-white">
      ...
      <div className="relative mx-auto w-full max-w-[1200px]">
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-white/10 pt-6 text-[10px] text-slate-500 sm:flex-row sm:items-center sm:justify-between"><span>© 2026 DolphinX Studio. All rights reserved.</span><span>{t("Thiết kế và phát triển tại Quảng Ngãi · Việt Nam", "Designed and developed in Quang Ngai · Vietnam")}</span></div>
      </div>
    </footer>
  );
}
