      ...
      <section className="relative overflow-hidden px-4 pb-16 pt-16 md:pb-24 md:pt-24" style={{ background: `radial-gradient(circle at 80% 12%, ${product.tone}, transparent 36%), #f8fbff` }}>
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="mt-12 grid items-end gap-10 md:grid-cols-[1.15fr_.85fr]">
            <div><span className="text-[10px] font-black tracking-[.16em] text-[#075fc2]">{product.category.toUpperCase()}</span><h1 className="mt-5 max-w-4xl font-[family-name:var(--display)] text-[clamp(48px,7vw,88px)] font-semibold leading-[.98] tracking-[-.06em]">{product.headline}</h1></div>
